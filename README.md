# Cursed Titanfall
A collection of very chaotic and zany ideas that sdarkmagic decided to implement into the game.
...
Fork that im using to learn Titanfall 2 modding(and how to use github....). 
