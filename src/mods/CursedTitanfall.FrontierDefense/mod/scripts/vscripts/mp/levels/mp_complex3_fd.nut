...
void function initFrontierDefenseData()
{
    ...
    PlaceFDShop( < 269, -3384, 3000 >, < 0, 45, 0 > )
	SetFDGroundSpawn( < -9, -2535, 520 >, < 0, -170, 0 > )
	OverrideFDHarvesterLocation( < -7600, -3900, -50000>, < 0, 85, 0 > )
...
//    WaveSpawn_BossTitanSpawn_Random( wave1, [ eFD_Bosses.Kane ], < -7468, -612, 576>, 0.0, "", 4.2 )
//    WaveSpawn_BossTitanSpawn_Random( wave1, [ eFD_Bosses.Ash ], < -7468, -612, 576>, 0.0, "", 4.2 )
//    WaveSpawn_BossTitanSpawn_Random( wave1, [ eFD_Bosses.Viper ], < -7468, -612, 576>, 0.0, "", 4.2 )
 ...
 //   WaveSpawn_BossTitanSpawn_Random( wave1, [ eFD_Bosses.Slone ], < -7468, -612, 576>, 0.0, "", 4.2 )
    WaveSpawn_Announce( wave1, "EliteTitans", 0.0 )
    WaveSpawn_TitanSpawn( wave1, "Sniper", < -3126, -2052, 691 >, -0.0, "", 1.6 )


WaveSpawn_TitanSpawn( wave1, "Northstar", < -9459, -4402, 582 >, 45, "", 0.5, "", 0.0, eFDSD.ALL, eFDTT.TITAN_ELITE )
//    WaveSpawn_EliteArcSpawn( wave1, < -7277, -799, 580 >, -45, "", 0.6 )
//    WaveSpawn_EliteArcSpawn( wave1, < -7277, -799, 580 >, -45, "", 0.6 )
//    WaveSpawn_EliteArcSpawn( wave1, < -7277, -799, 580 >, -45, "", 0.6 )
//    WaveSpawn_EliteArcSpawn( wave1, < -7277, -799, 580 >, -45, "", 0.6 )
 //   WaveSpawn_EliteArcSpawn( wave1, < -7277, -799, 580 >, -45, "", 0.6 )
 //   WaveSpawn_TitanSpawn( wave1, "Ion", < -2453, 389, 558 >, 0, "", 0.5, "", 0.0, eFDSD.ALL, eFDTT.TITAN_ELITE )
  //  WaveSpawn_TitanSpawn( wave1, "Ion", < -2453, 389, 558 >, 0, "", 0.5, "", 0.0, eFDSD.ALL, eFDTT.TITAN_ELITE )
//    WaveSpawn_TitanSpawn( wave1, "Ronin", < -1192, 255, 520 >, -90, "", 0.5, "", 0.0, eFDSD.ALL, eFDTT.TITAN_ELITE )
 //   WaveSpawn_TitanSpawn( wave1, "Northstar", < -9459, -4402, 582 >, 45, "", 0.5, "", 0.0, eFDSD.ALL, eFDTT.TITAN_ELITE )
	WaveSpawn_ReaperSpawn( wave1, "TickReaper", < -2908, -1900, 668 >, 90, "", 0.2)
	WaveSpawn_ReaperSpawn( wave1, "TickReaper", < -2908, -1900, 668 >, 90, "", 0.2)
	WaveSpawn_ReaperSpawn( wave1, "TickReaper", < -2908, -1900, 668 >, 90, "", 0.2)
	WaveSpawn_ReaperSpawn( wave1, "TickReaper", < -2908, -1900, 668 >, 90, "", 0.2)
	WaveSpawn_ReaperSpawn( wave1, "TickReaper", < -2908, -1900, 668 >, 90, "", 0.2)
	...
	*/
    ...
    WaveSpawn_Announce( wave2, "EliteTitans", 0.0 )
	WaveSpawn_InfantrySpawn( wave2, "PodGrunt", < -9161, -4266, 580 >, 0.0, "", 0.2 )
	WaveSpawn_InfantrySpawn( wave2, "Stalker", < -801, -375, 591 >, 0.0, "", 0.1 )
    WaveSpawn_TitanSpawn( wave2, "Nuke", < -4487, -4554, 659 >, 45, "", 5.0, "", 0.0, eFDSD.ALL, eFDTT.TITAN_ELITE )
    WaveSpawn_TitanSpawn( wave2, "Nuke", < -4487, -4554, 659 >, 45, "", 5.0, "", 0.0, eFDSD.ALL, eFDTT.TITAN_ELITE )
    WaveSpawn_TitanSpawn( wave2, "Nuke", < -4487, -4554, 659 >, 45, "", 5.0, "", 0.0, eFDSD.ALL, eFDTT.TITAN_ELITE )
	WaveSpawn_TitanSpawn( wave2, "Ronin", < -4487, -4554, 659 >, 45, "", 5.0, "", 0.0, eFDSD.ALL, eFDTT.TITAN_ELITE )
	WaveSpawn_TitanSpawn( wave2, "Ronin", < -4487, -4554, 659 >, 45, "", 5.0, "", 0.0, eFDSD.ALL, eFDTT.TITAN_ELITE )
	WaveSpawn_TitanSpawn( wave2, "Ronin", < -4487, -4554, 659 >, 45, "", 5.0, "", 0.0, eFDSD.ALL, eFDTT.TITAN_ELITE )
	WaveSpawn_WaitEnemyAliveAmount( wave2, 14 )
	WaveSpawn_ReaperSpawn( wave2, "TickReaper", < -2908, -1900, 668 >, 90, "", 0.2)
	WaveSpawn_ReaperSpawn( wave2, "TickReaper", < -2908, -1900, 668 >, 90, "", 0.2)
	WaveSpawn_ReaperSpawn( wave2, "TickReaper", < -2908, -1900, 668 >, 90, "", 0.2)
    WaveSpawn_BossTitanSpawn_Random( wave2, [ eFD_Bosses.Slone ], < -7468, -612, 576>, 0.0, "", 4.2 )
    WaveSpawn_BossTitanSpawn_Random( wave2, [ eFD_Bosses.Viper ], < -7468, -612, 576>, 0.0, "", 4.2 )
	WaveSpawn_WaitEnemyAliveAmount( wave2, 8 )
	WaveSpawn_EliteArcSpawn( wave2, < -7277, -799, 580 >, -45, "", 0.6 )
	WaveSpawn_EliteArcSpawn( wave2, < -7277, -799, 580 >, -45, "", 0.6 )
	WaveSpawn_EliteArcSpawn( wave2, < -7277, -799, 580 >, -45, "", 0.6 )
	WaveSpawn_EliteArcSpawn( wave2, < -7277, -799, 580 >, -45, "", 0.6 )
	...
	WaveSpawn_TitanSpawn( wave2, "Northstar", < -9459, -4402, 582 >, 45, "", 0.5, "", 0.0, eFDSD.ALL, eFDTT.TITAN_ELITE )
    ...
    WaveSpawn_TitanSpawn( wave2, "Ion", < -2453, 389, 558 >, 0, "", 0.5, "", 0.0, eFDSD.ALL, eFDTT.TITAN_ELITE )
	WaveSpawn_TitanSpawn( wave2, "Ion", < -2453, 389, 558 >, 0, "", 0.5, "", 0.0, eFDSD.ALL, eFDTT.TITAN_ELITE )
	WaveSpawn_TitanSpawn( wave2, "Ion", < -2453, 389, 558 >, 0, "", 0.5, "", 0.0, eFDSD.ALL, eFDTT.TITAN_ELITE )
	WaveSpawn_TitanSpawn( wave2, "Ion", < -2453, 389, 558 >, 0, "", 0.5, "", 0.0, eFDSD.ALL, eFDTT.TITAN_ELITE )
	WaveSpawn_WaitEnemyAliveAmount( wave2, 14 )
    ...
    WaveSpawn_InfantrySpawn( wave2, "Spectre", < -5351, -2445, 692 >, 0.0, "", 0.1 )
    WaveSpawn_InfantrySpawn( wave2, "PodGrunt", < -6245, 461, 576 >, 0.0, "westApproach_InfantryTick", 0.2 )
   	WaveSpawn_InfantrySpawn( wave2, "PodGrunt", < -6245, 461, 576 >, 0.0, "westApproach_InfantryTick", 0.2 )
	WaveSpawn_InfantrySpawn( wave2, "PodGrunt", < -6245, 461, 576 >, 0.0, "westApproach_InfantryTick", 0.2 )
	WaveSpawn_BossTitanSpawn_Random( wave2, [ eFD_Bosses.Slone ], < -7468, -612, 576>, 0.0, "", 4.2 )
	WaveSpawn_BossTitanSpawn_Random( wave2, [ eFD_Bosses.Slone ], < -7468, -612, 576>, 0.0, "", 4.2 )
	...
	*/
	...
	WaveSpawn_EliteArcSpawn( wave3, < -7277, -799, 580 >, -45, "", 0.6 )
	WaveSpawn_EliteArcSpawn( wave3, < -7277, -799, 580 >, -45, "", 0.6 )
	WaveSpawn_EliteArcSpawn( wave3, < -7277, -799, 580 >, -45, "", 0.6 )
	WaveSpawn_EliteArcSpawn( wave3, < -7277, -799, 580 >, -45, "", 0.6 )
	WaveSpawn_EliteArcSpawn( wave3, < -7277, -799, 580 >, -45, "", 0.6 )
	WaveSpawn_TitanSpawn( wave3, "Ion", < -2453, 389, 558 >, 0, "", 0.5, "", 0.0, eFDSD.ALL, eFDTT.TITAN_ELITE )
	WaveSpawn_TitanSpawn( wave3, "Ion", < -2453, 389, 558 >, 0, "", 0.5, "", 0.0, eFDSD.ALL, eFDTT.TITAN_ELITE )
	WaveSpawn_TitanSpawn( wave3, "Ion", < -2453, 389, 558 >, 0, "", 0.5, "", 0.0, eFDSD.ALL, eFDTT.TITAN_ELITE )
	...
	WaveSpawn_TitanSpawn( wave3, "Monarch", < -1192, 255, 520 >, -90, "", 0.5, "", 0.0, eFDSD.ALL, eFDTT.TITAN_ELITE )
	WaveSpawn_TitanSpawn( wave3, "Monarch", < -1192, 255, 520 >, -90, "", 0.5, "", 0.0, eFDSD.ALL, eFDTT.TITAN_ELITE )
	WaveSpawn_TitanSpawn( wave3, "Monarch", < -1192, 255, 520 >, -90, "", 0.5, "", 0.0, eFDSD.ALL, eFDTT.TITAN_ELITE )
	WaveSpawn_TitanSpawn( wave3, "Scorch", < -1192, 255, 520 >, -90, "", 0.5, "", 0.0, eFDSD.ALL, eFDTT.TITAN_ELITE )
	WaveSpawn_TitanSpawn( wave3, "Scorch", < -1192, 255, 520 >, -90, "", 0.5, "", 0.0, eFDSD.ALL, eFDTT.TITAN_ELITE )
	WaveSpawn_BossTitanSpawn_Random( wave3, [ eFD_Bosses.Viper ], < -7468, -612, 576>, 0.0, "", 4.2 )
	WaveSpawn_BossTitanSpawn_Random( wave3, [ eFD_Bosses.Viper ], < -7468, -612, 576>, 0.0, "", 4.2 )
	WaveSpawn_BossTitanSpawn_Random( wave3, [ eFD_Bosses.Viper ], < -7468, -612, 576>, 0.0, "", 4.2 )
	WaveSpawn_BossTitanSpawn_Random( wave3, [ eFD_Bosses.Viper ], < -7468, -612, 576>, 0.0, "", 4.2 )
	WaveSpawn_BossTitanSpawn_Random( wave3, [ eFD_Bosses.Viper ], < -7468, -612, 576>, 0.0, "", 4.2 )
	WaveSpawn_InfantrySpawn( wave3, "PodGrunt", < -6245, 461, 576 >, 0.0, "westApproach_InfantryTick", 0.2 )
	WaveSpawn_InfantrySpawn( wave3, "PodGrunt", < -6245, 461, 576 >, 0.0, "westApproach_InfantryTick", 0.2 )
	WaveSpawn_InfantrySpawn( wave3, "PodGrunt", < -6245, 461, 576 >, 0.0, "westApproach_InfantryTick", 0.2 )
	WaveSpawn_InfantrySpawn( wave3, "PodGrunt", < -6245, 461, 576 >, 0.0, "westApproach_InfantryTick", 0.2 )
	WaveSpawn_WaitEnemyAliveAmount( wave3, 16 )

	WaveSpawn_TitanSpawn( wave3, "Tone", < -9663, -4165, 581 >, 45, "", 0.5, "", 0.0, eFDSD.ALL, eFDTT.TITAN_ELITE )
	WaveSpawn_TitanSpawn( wave3, "Tone", < -9663, -4165, 581 >, 45, "", 0.5, "", 0.0, eFDSD.ALL, eFDTT.TITAN_ELITE )
	WaveSpawn_TitanSpawn( wave3, "Tone", < -9663, -4165, 581 >, 45, "", 0.5, "", 0.0, eFDSD.ALL, eFDTT.TITAN_ELITE )
	...
	WaveSpawn_TitanSpawn( wave3, "Nuke", < -7863, -990, 632 >, -45, "", 0.2 )
	WaveSpawn_TitanSpawn( wave3, "Nuke", < -7262, -281, 632 >, -45, "", 0.2 )
...
void function RegisterCustomFDContent()
{
	...
	// TODO.md: Add logic for arc core here to allow a oncer per match 15s freeze of all enemies
