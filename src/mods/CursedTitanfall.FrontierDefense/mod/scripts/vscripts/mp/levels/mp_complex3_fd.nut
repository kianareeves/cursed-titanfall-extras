...
void function initFrontierDefenseData()
{
	...
	*/
    ...
    WaveSpawn_TitanSpawn( wave1, "Ronin", < -4487, -4554, 659 >, 45, "", 5.0, "", 0.0, eFDSD.ALL, eFDTT.TITAN_ELITE )
	WaveSpawn_TitanSpawn( wave1, "Ronin", < -4487, -4554, 659 >, 45, "", 5.0, "", 0.0, eFDSD.ALL, eFDTT.TITAN_ELITE )
	WaveSpawn_TitanSpawn( wave1, "Ronin", < -4487, -4554, 659 >, 45, "", 5.0, "", 0.0, eFDSD.ALL, eFDTT.TITAN_ELITE )
	...
	*/
	...
	WaveSpawn_BossTitanSpawn_Random( wave3, [ eFD_Bosses.Kane ], < -7468, -612, 576>, 0.0, "", 4.2 )
	WaveSpawn_BossTitanSpawn_Random( wave3, [ eFD_Bosses.Viper ], < -7468, -612, 576>, 0.0, "", 4.2 )
	WaveSpawn_BossTitanSpawn_Random( wave3, [ eFD_Bosses.Viper ], < -7468, -612, 576>, 0.0, "", 4.2 )
	WaveSpawn_BossTitanSpawn_Random( wave3, [ eFD_Bosses.Viper ], < -7468, -612, 576>, 0.0, "", 4.2 )
    ...
    WaveSpawn_BossTitanSpawn_Random( wave3, [ eFD_Bosses.Richter ], < -7468, -612, 576>, 0.0, "", 4.2 )
	...
	WaveSpawn_BossTitanSpawn_Random( wave3, [ eFD_Bosses.Ash ], < -941, 668, 568 >, -90, "", 0.2 )
	WaveSpawn_BossTitanSpawn_Random( wave3, [ eFD_Bosses.Ash ], < -941, 668, 568 >, -90, "", 0.2 )
	WaveSpawn_TitanSpawn( wave3, "Nuke", < -2453, 389, 558 >, 0, "", 0.5 )
	WaveSpawn_TitanSpawn( wave3, "Nuke", < -2453, 389, 558 >, 0, "", 0.5 )
	WaveSpawn_TitanSpawn( wave3, "Nuke", < -2453, 389, 558 >, 0, "", 0.5 )
	WaveSpawn_TitanSpawn( wave3, "Nuke", < -2453, 389, 558 >, 0, "", 0.5 )
	WaveSpawn_TitanSpawn( wave3, "Nuke", < -2453, 389, 558 >, 0, "", 0.5 )
