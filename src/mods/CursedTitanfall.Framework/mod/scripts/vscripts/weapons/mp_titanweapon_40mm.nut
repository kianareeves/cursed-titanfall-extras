...
global function AddCallback_OnPrimaryAttackPlayer_titanweapon_40mm
#if SERVER
...
struct {
    array< void functionref( entity, WeaponPrimaryAttackParams ) > onPrimaryAttackPlayerCallbacks_titanweapon_40mm
} file

void function AddCallback_OnPrimaryAttackPlayer_titanweapon_40mm( void functionref( entity, WeaponPrimaryAttackParams ) callback )
{
    Assert( !file.onPrimaryAttackPlayerCallbacks_titanweapon_40mm.contains( callback ), "Already added " + string( callbackFunc ) + " with AddCallback_OnPrimaryAttackPlayer_titanweapon_40mm"  )
	file.onPrimaryAttackPlayerCallbacks_titanweapon_40mm.append( callback )
}
//////////////////////////////////////
...
int function FireWeaponPlayerAndNPC( WeaponPrimaryAttackParams attackParams, bool playerFired, entity weapon )
{
	if ( playerFired )
	{
		foreach( callback in file.onPrimaryAttackPlayerCallbacks_titanweapon_40mm )
		{
